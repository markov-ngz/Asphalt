...
public class EnrichedVehiclePositionKafkaRecordDeserializationSchema implements KafkaRecordDeserializationSchema<EnrichedVehiclePosition> {
     ...
     */
    protected EnrichedVehiclePosition parseRecord(ConsumerRecord<byte[], byte[]> record) throws MissingRecordHeaderError, MissingRecordValueError ,VehiclePositionProtoValueError{
